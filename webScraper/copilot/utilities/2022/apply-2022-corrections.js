...
class Apply2022Corrections {
    constructor() {
        this.jsonDir = path.join(__dirname, '..', 'localCopy', 'paccentraljc.org', 'awards', '2022', 'data', 'json');
        this.htmlDir = path.join(__dirname, '..', 'localCopy', 'paccentraljc.org', 'awards', '2022', 'html');
        this.correctionsFile = path.join(__dirname, '..', 'localCopy', 'paccentraljc.org', 'awards', '2022', 'data', 'errorChecking', '2022-categorized-issues-25.10.06-1831.json');
        this.fixes = {
            crossFixed: [],
            problematicFixed: [],
            errors: []
    ...
    async run() {
        console.log('🔧 Applying 2022 Data Corrections\n');
...
// Run the corrections
const corrector = new Apply2022Corrections();
