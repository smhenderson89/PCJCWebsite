...
class Enhanced2022Extractor {
    ...
    async run() {
        console.log('🚀 Starting ENHANCED 2022 Awards JSON Extraction with Display Detection\n');
    ...
    async generateReport() {
        ...
        // Print summary
        console.log('\n📋 ENHANCED 2022 JSON Extraction Summary:');
        ...
        const reportPath = path.join(path.dirname(this.jsonDir), '2022-ENHANCED-json-extraction-report.json');
        const reportData = {
...
const extractor = new Enhanced2022Extractor();
