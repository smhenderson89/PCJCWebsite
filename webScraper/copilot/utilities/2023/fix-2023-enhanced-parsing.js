    ...
    try {
        ...
        if (hasChanges) {
            ...
            data.corrections.push({
                ...
                type: 'enhanced_html_parsing_2023',
...
function fix2023RecoverableIssuesEnhanced() {
    console.log('Starting enhanced fix for 2023 recoverable issues from HTML sources...');
    ...
    console.log('2023 ENHANCED RECOVERABLE ISSUES FIX SUMMARY');
    console.log('='.repeat(70));
...
function fix2023MeasurementOnlyIssues() {
    console.log('Checking 2023 measurement-only issues for possible fixes...');
            ...
            try {
                ...
                if (Object.keys(foundMeasurements).length > 0) {
                    ...
                    if (hasChanges) {
                        ...
                        data.corrections.push({
                            timestamp: new Date().toISOString(),
                            type: 'measurement_extraction_2023',
...
// Run both fixes
fix2023RecoverableIssuesEnhanced();
console.log('\n');
fix2023MeasurementOnlyIssues();