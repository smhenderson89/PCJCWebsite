...
/**
 * Fix 2023 Source URLs
 * 
 * Updates the sourceUrl field in 2023 JSON files to reflect the actual source URL structure:
 * From: "https://www.paccentraljc.org/awards/[awardNum]"
 * To: "https://www.paccentraljc.org/[YYYYMMDD]/[awardNum].html"
 * 
 * Usage: node fix-2023-source-urls.js
 */
...
class SourceUrlFixer2023 {
     ...
     * @param {string} dateStr - Date string like "January 20, 2023"
     * @returns {string} - YYYYMMDD format like "20230120"
     */
    ...
    async fixSourceUrl(filePath) {
        try {
            ...
            // Need to fix if: contains '/awards/' OR has 6-digit date format (230120 instead of 20230120)
    ...
    /**
     * Process all JSON files in the 2023 directory
     */
    async processAllFiles() {
        console.log('🔧 Fixing source URLs for 2023...');
...
async function main() {
    try {
        const fixer = new SourceUrlFixer2023();
        await fixer.processAllFiles();
        
        console.log(`\n🎉 Source URL correction complete for 2023!`);
...
module.exports = SourceUrlFixer2023;