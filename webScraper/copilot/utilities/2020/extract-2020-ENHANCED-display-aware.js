...
class Enhanced2020Extractor {
    ...
    async run() {
        console.log('🚀 Starting ENHANCED 2020 Awards JSON Extraction with Display Detection\n');
        ...
        const awardFiles = allFiles.filter(file => 
            file.endsWith('.html') && 
            file.match(/^20205\d{3}\.html$/) // Only individual awards (20205XXX)
        );
    ...
    async generateReport() {
        ...
        // Print summary
        console.log('\n📋 ENHANCED 2020 JSON Extraction Summary:');
        ...
        const reportPath = path.join(path.dirname(this.jsonDir), '2020-ENHANCED-json-extraction-report.json');
        const reportData = {
        ...
        console.log('\n✅ ENHANCED 2020 JSON extraction complete!');
    }
}

// Run the enhanced extraction
const extractor = new Enhanced2020Extractor();
