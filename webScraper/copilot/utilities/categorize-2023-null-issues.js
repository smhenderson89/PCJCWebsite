...
const outputPath = '/Users/scotthenderson/Programming/Freelancing/Orchid Society/Github/PCJCWebsite/webScraper/copilot/savedData/2023/2023-categorized-issues.json';

function categorize2023NullIssues() {
    console.log('Categorizing 2023 null value issues...');
    ...
    for (const fileInfo of filesWithNulls) {
        ...
        // Other minor issues
            ...
            const hasOptionalFields = nullFields.some(field => 
                ['clone', 'cross', 'photographer', 'thumbnail'].includes(field)
            );
    ...
    try {
        ...
        console.log('\n' + '='.repeat(60));
        console.log('2023 NULL VALUE CATEGORIZATION SUMMARY');
