...
// Configuration
const HTML_DIR = path.join(__dirname, '../../paccentraljc.org/awards/2016/html');

console.log('🧹 Starting 2016 Duplicate File Cleanup Process...\n');
...
function findDuplicateFiles() {
    ...
    const datePattern = /^(2016\d{4})\.html$/;
    const indexPattern = /^(2016\d{4})-index\.html$/;
