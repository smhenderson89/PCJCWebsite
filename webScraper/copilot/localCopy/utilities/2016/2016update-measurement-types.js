/**
 * Update measurement type for 2016 JSON files
...
const htmlDataPath = path.join(__dirname, '../../paccentraljc.org/awards/2016/html');
 ...
 * @param {Object} data - The JSON data object
 * @param {string} filename - The filename (e.g., "20162301.json")
...
if (require.main === module) {
    console.log('Updating 2016 JSON files: Adding missing measurements and categorizing types...\n');
