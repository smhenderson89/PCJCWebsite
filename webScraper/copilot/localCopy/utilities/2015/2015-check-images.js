/**
 * 2015 Image Validation Script
 * Check that all 2015 awards have corresponding image files saved locally
 */
...
// Path to the 2015 images directory
const imagesPath = path.join(__dirname, '../../paccentraljc.org/awards/2015/images');

/**
 * Main image checking function
 */
function checkAllImages() {
    console.log('🖼️  2015 IMAGE VALIDATION CHECK');
    ...
    // Print summary
    console.log('\n' + '=' .repeat(80));
    console.log('📊 2015 IMAGE VALIDATION SUMMARY');
    ...
    const reportPath = path.join(reportsDir, '2015-image-check-report.json');
