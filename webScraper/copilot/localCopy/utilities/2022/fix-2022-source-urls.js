...
class SourceUrlFixer2022 {
    constructor() {
        this.baseDir = path.join(__dirname, '../../paccentraljc.org/awards/2022/data/json');
        this.backupDir = path.join(__dirname, '../../paccentraljc.org/awards/2022/data/backups');
        this.results = {
            processed: 0,
            updated: 0,
            errors: [],
    ...
    async fixSourceUrl(filePath) {
        try {
            ...
            // Need to fix if: contains '/awards/' OR has 6-digit date format (230120 instead of 20220120)
    ...
    async generateReport() {
        ...
        const reportPath = path.join(__dirname, '../../paccentraljc.org/awards/2022/data/2022-source-url-fixes-report.json');
