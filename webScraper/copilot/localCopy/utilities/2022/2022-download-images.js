/**
 * 2022 Image Download Script
 * Download missing images for 2022 awards from their source URLs
 */
...
function constructImageUrl(sourceUrl, awardNum) {
    ...
    // e.g., https://www.paccentraljc.org/20221116/20224887.html
    // becomes https://www.paccentraljc.org/20221116/20224887.jpg
...
async function downloadMissingImages() {
    console.log('📸 2022 MISSING IMAGE DOWNLOAD');
    ...
    // Print summary
    console.log('\\n' + '=' .repeat(80));
    console.log('📊 2022 IMAGE DOWNLOAD SUMMARY');
    ...
    const reportPath = path.join(reportsDir, '2022-image-download-report.json');
