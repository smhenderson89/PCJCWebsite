/**
 * 2024 Image Validation Script
 * Check that all 2024 awards have corresponding image files saved locally
 */

const fs = require('fs');
const path = require('path');

// Path to the 2024 JSON data directory
const jsonDataPath = path.join(__dirname, '../../paccentraljc.org/awards/2024/data/json');
// Path to the 2024 images directory
const imagesPath = path.join(__dirname, '../../paccentraljc.org/awards/2024/images');

/**
 * Main image checking function
 */
function checkAllImages() {
    console.log('🖼️  2024 IMAGE VALIDATION CHECK');
    ...
    // Print summary
    console.log('\n' + '=' .repeat(80));
    console.log('📊 2024 IMAGE VALIDATION SUMMARY');
    ...
    const reportPath = path.join(reportsDir, '2024-image-check-report.json');
