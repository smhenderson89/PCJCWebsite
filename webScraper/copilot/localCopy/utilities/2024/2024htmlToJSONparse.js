...
const jsonDirectory = path.join(__dirname, '../../paccentraljc.org/awards/2024/data/json');
const htmlDirectory = path.join(__dirname, '../../paccentraljc.org/awards/2024/html');
 ...
 * @param {string} dateStr - Date string like "February 15, 2024"
...
function extractFullAwardDataFromHtml(awardNum) {
    ...
    try {
        ...
        const extractedData = {
            ...
            htmlReference: `localCopy/paccentraljc.org/awards/2024/html/${awardNum}.html`,
            year: 2024
        };
...
function processAll2024Files() {
    ...
    const reportPath = path.join(jsonDirectory, '../2024-enhanced-processing-report.json');
    const report = {
        timestamp: new Date().toISOString(),
