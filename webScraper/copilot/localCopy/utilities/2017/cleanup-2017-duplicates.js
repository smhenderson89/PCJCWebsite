...
// Configuration
const HTML_DIR = path.join(__dirname, '../../paccentraljc.org/awards/2017/html');

console.log('🧹 Starting 2017 Duplicate File Cleanup Process...\n');
...
function findDuplicateFiles() {
    ...
    const datePattern = /^(2017\d{4})\.html$/;
    const indexPattern = /^(2017\d{4})-index\.html$/;
