/**
 * 2018 URL Validation Script
 * Check that all source URLs in 2018 awards return HTTP 200
...
async function checkAllUrls() {
    console.log('🔗 2018 URL VALIDATION CHECK');
    ...
    // Print summary
    console.log('\n' + '=' .repeat(80));
    console.log('📊 2018 URL VALIDATION SUMMARY');
    ...
    const reportPath = path.join(__dirname, '2018-url-check-report.json');
