/**
 * 2021 Image Validation Script
 * Check that all 2021 awards have corresponding image files saved locally
 */
...
// Path to the 2021 images directory
const imagesPath = path.join(__dirname, '../../paccentraljc.org/awards/2021/images');

/**
 * Main image checking function
 */
function checkAllImages() {
    console.log('🖼️  2021 IMAGE VALIDATION CHECK');
    ...
    // Print summary
    console.log('\n' + '=' .repeat(80));
    console.log('📊 2021 IMAGE VALIDATION SUMMARY');
    ...
    const reportPath = path.join(reportsDir, '2021-image-check-report.json');
