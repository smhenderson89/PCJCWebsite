...
const jsonDir = '/Users/scotthenderson/Programming/Freelancing/Orchid Society/Github/PCJCWebsite/webScraper/copilot/localCopy/paccentraljc.org/awards/2025/data/json';

console.log('🔍 2025 AWARDS - MISSING DATA ONLY ANALYSIS');
...
function displayResults(analysis) {
    ...
    // Save focused report
    const reportPath = path.join(jsonDir, '../2025-missing-data-focused-report.json');
    const report = {
        timestamp: new Date().toISOString(),
        purpose: "Focused analysis showing only 2025 awards with missing data",
        summary: {
    ...
    console.log(`\n📋 Focused report saved: 2025-missing-data-focused-report.json`);
