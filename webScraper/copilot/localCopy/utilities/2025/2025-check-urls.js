/**
 * 2025 URL Validation Script
 * Check that all source URLs in 2025 awards return HTTP 200
...
async function checkAllUrls() {
    console.log('🔗 2025 URL VALIDATION CHECK');
    ...
    // Print summary
    console.log('\n' + '=' .repeat(80));
    console.log('📊 2025 URL VALIDATION SUMMARY');
    ...
    const reportPath = path.join(reportsDir, '2025-url-check-report.json');
