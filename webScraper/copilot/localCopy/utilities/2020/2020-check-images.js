/**
 * 2020 Image Validation Script
 * Check that all 2020 awards have corresponding image files saved locally
 */

const fs = require('fs');
const path = require('path');

// Path to the 2020 JSON data directory
const jsonDataPath = path.join(__dirname, '../../paccentraljc.org/awards/2020/data/json');
// Path to the 2020 images directory
const imagesPath = path.join(__dirname, '../../paccentraljc.org/awards/2020/images');

/**
 * Main image checking function
 */
function checkAllImages() {
    console.log('🖼️  2020 IMAGE VALIDATION CHECK');
    ...
    // Print summary
    console.log('\n' + '=' .repeat(80));
    console.log('📊 2020 IMAGE VALIDATION SUMMARY');
    ...
    const reportPath = path.join(reportsDir, '2020-image-check-report.json');
