/**
 * 2019 URL Validation Script
 * Check that all source URLs in 2019 awards return HTTP 200
...
async function checkAllUrls() {
    console.log('🔗 2019 URL VALIDATION CHECK');
    ...
    // Print summary
    console.log('\n' + '=' .repeat(80));
    console.log('📊 2019 URL VALIDATION SUMMARY');
    ...
    const reportPath = path.join(__dirname, 'reports', '2019-url-check-report.json');
