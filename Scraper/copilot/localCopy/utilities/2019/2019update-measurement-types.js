/**
 * Update measurement type for 2019 JSON files
 ...
 * @param {Object} data - The JSON data object
 * @param {string} filename - The filename (e.g., "20192301.json")
...
if (require.main === module) {
    console.log('Updating 2019 JSON files: Adding missing measurements and categorizing types...\n');
