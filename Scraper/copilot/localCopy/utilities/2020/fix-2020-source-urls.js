...
console.log('🔧 Fixing 2020 source URLs from YYYMMDD to YYYYMMDD format...\n');

function fixSourceUrl(url) {
    // Multiple patterns to fix:
    // Pattern 1: https://www.paccentraljc.org/2020124/20205250.html (missing one 0)
    // Pattern 2: https://www.paccentraljc.org/200220/20205304.html (missing two 0s) 
    // Should be: https://www.paccentraljc.org/20200124/20205250.html
    ...
    if (match1) {
        ...
        const awardNum = match1[2]; // e.g., "20205250"
        
        // Convert to full YYYYMMDD format
        const fullDateCode = `2020${dateCode}`;
    ...
    if (match2) {
        ...
        const awardNum = match2[2]; // e.g., "20205304"
...
try {
        ...
        try {
            ...
            if (awardData.sourceUrl) {
                ...
                if (result.fixed) {
                    ...
                    awardData.corrections.push({
                        ...
                        source: "automated-2020-source-url-format-fix",
                        reason: "Updated date format from YYYMMDD to YYYYMMDD (202MMDD → 2020MMDD)"
                    });
            ...
            if (changed) {
                ...
                awardData.changeLog.push({
                    ...
                    field: "sourceUrl",
                    changes: changes,
                    source: "automated-2020-url-format-correction",
    ...
    console.log('\n' + '='.repeat(60));
    console.log('📊 2020 SOURCE URL FIX SUMMARY');
    ...
    if (fixedCount > 0) {
        console.log(`\n🔧 FIXED URL PATTERN:`);
        console.log(`   Before: https://www.paccentraljc.org/2020124/awardNum.html (YYYMMDD)`);
        console.log(`   After:  https://www.paccentraljc.org/20200124/awardNum.html (YYYYMMDD)`);
        
        console.log(`\n✅ All 2020 source URLs now use proper YYYYMMDD format!`);
    }
    
    console.log('\n🎉 2020 source URL format correction complete!');
