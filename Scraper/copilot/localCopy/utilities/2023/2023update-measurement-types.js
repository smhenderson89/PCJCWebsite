/**
 * Update measurement type for 2023 JSON files
...
const htmlDataPath = path.join(__dirname, '../../paccentraljc.org/awards/2023/html');
 ...
 * @param {Object} data - The JSON data object
 * @param {string} filename - The filename (e.g., "20232301.json")
...
if (require.main === module) {
    console.log('Updating 2023 JSON files: Adding missing measurements and categorizing types...\n');
