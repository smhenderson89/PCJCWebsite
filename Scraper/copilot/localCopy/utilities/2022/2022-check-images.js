/**
 * 2022 Image Validation Script
 * Check that all 2022 awards have corresponding image files saved locally
 */
...
function checkAllImages() {
    console.log('🖼️  2022 IMAGE VALIDATION CHECK');
    ...
    // Print summary
    console.log('\n' + '=' .repeat(80));
    console.log('📊 2022 IMAGE VALIDATION SUMMARY');
    ...
    const reportPath = path.join(reportsDir, '2022-image-check-report.json');
