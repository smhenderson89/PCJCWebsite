/**
 * 2022 Master Data Check Script
 * Comprehensive verification of 2022 orchid awards data
...
// Path to the 2022 JSON data directory
...
function runMasterCheck() {
    console.log('🔍 2022 MASTER DATA CHECK');
    ...
    const reportPath = path.join(__dirname, '2022-master-check-report.json');
...
function printSummary(results) {
    console.log('\n' + '=' .repeat(80));
    console.log('📊 2022 DATA VERIFICATION SUMMARY');
    ...
    if (results.filesWithIssues === 0) {
        console.log('🎉 ALL DATA CHECKS PASSED! The 2022 dataset is clean and properly categorized.');
    } else {
