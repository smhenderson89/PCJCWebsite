/**
 * 2015 URL Validation Script
 * Check that all source URLs in 2015 awards return HTTP 200
...
async function checkAllUrls() {
    console.log('🔗 2015 URL VALIDATION CHECK');
    ...
    // Print summary
    console.log('\n' + '=' .repeat(80));
    console.log('📊 2015 URL VALIDATION SUMMARY');
    ...
    const reportPath = path.join(__dirname, '2015-url-check-report.json');
