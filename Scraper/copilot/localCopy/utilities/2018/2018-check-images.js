/**
 * 2018 Image Validation Script
 * Check that all 2018 awards have corresponding image files saved locally
 */
...
// Path to the 2018 images directory
const imagesPath = path.join(__dirname, '../../paccentraljc.org/awards/2018/images');

/**
 * Main image checking function
 */
function checkAllImages() {
    console.log('🖼️  2018 IMAGE VALIDATION CHECK');
    ...
    // Print summary
    console.log('\n' + '=' .repeat(80));
    console.log('📊 2018 IMAGE VALIDATION SUMMARY');
    ...
    const reportPath = path.join(reportsDir, '2018-image-check-report.json');
