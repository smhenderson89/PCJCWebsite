/**
 * Update measurement type for 2024 JSON files
...
const htmlDataPath = path.join(__dirname, '../../paccentraljc.org/awards/2024/html');
...
function isDisplayOrSpecialAward(data) {
    ...
    if (data.award) {
        ...
        return award.includes("show trophy") ||
               ...
               award === "sc" ||  // Special Culture Award (display)
 ...
 * @param {Object} data - The JSON data object
 * @param {string} filename - The filename (e.g., "20242301.json")
...
if (require.main === module) {
    console.log('Updating 2024 JSON files: Adding missing measurements and categorizing types...\n');
